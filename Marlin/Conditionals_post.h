...
#define CONDITIONALS_POST_H
  ...
  #define SYSTEM_SECTION SUBSECTION(CONDITIONALS, 1)
  ...
  #define HAS_ADC_TEST(P) (PIN_EXISTS(TEMP_##P) && TEMP_SENSOR_##P != 0 && TEMP_SENSOR_##P > -5)
  ...
  #define WRITE_HEATER_0P(v) WRITE(HEATER_0_PIN, v)
    ...
    #define WRITE_HEATER_1(v) { WRITE(HEATER_0_PIN, v); WRITE(HEATER_1_PIN, v); }
    //#define WRITE_HEATER_1(v) { WRITE(HEATER_1_PIN, v);}
    #if HOTENDS > 2
      #define WRITE_HEATER_2(v) { WRITE(HEATER_4_PIN, v); WRITE(HEATER_5_PIN, v); }
      #if HOTENDS > 3
        #define WRITE_HEATER_3(v) {WRITE(HEATER_6_PIN, v); WRITE(HEATER_7_PIN,v}
        #if HOTENDS > 4
